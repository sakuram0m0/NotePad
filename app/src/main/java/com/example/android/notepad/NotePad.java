...
public final class NotePad {
    public static final String AUTHORITY = "com.goo.provider.NotePad";
    ...
    public static final class Notes implements BaseColumns {
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.goo.note";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single
         * note.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.goo.note";
